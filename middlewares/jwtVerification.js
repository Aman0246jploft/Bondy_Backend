...
const publicRoutes = [
  ...
  "/api/v1/user/staff/forgot-password/init",
  "/api/v1/user/staff/forgot-password/verify",
  "/api/v1/user/staff/forgot-password/resend",
  "/api/v1/user/staff/reset-password",
