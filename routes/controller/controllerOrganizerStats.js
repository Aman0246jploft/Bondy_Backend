    ...
    async (req, res) => {
        try {
            ...
            if (result.statusCode === SUCCESS) {
                ...
                return apiErrorRes(HTTP_STATUS.INTERNAL_SERVER_ERROR, res, "Failed to fetch wallet history");
            }
        } catch (error) {
    ...
    async (req, res) => {
        try {
            ...
            if (result.statusCode === SUCCESS) {
                ...
                return apiErrorRes(HTTP_STATUS.INTERNAL_SERVER_ERROR, res, "Failed to fetch payouts");
            }
        } catch (error) {
...
router.get(
    ...
    async (req, res) => {
        try {
            ...
            const result = await organizerStatsService.getOrganizerStatsSummary(
                organizerId
            );
            ...
            if (result.statusCode === SUCCESS) {
                ...
                return apiErrorRes(HTTP_STATUS.INTERNAL_SERVER_ERROR, res, "Failed to fetch statistics");
            }
        } catch (error) {
