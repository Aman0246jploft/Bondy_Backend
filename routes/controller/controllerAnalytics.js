...
router.get(
    ...
    async (req, res) => {
        try {
            ...
            return apiSuccessRes(result.status, res, result.data, "Global stats fetched successfully");
        } catch (error) {
...
router.get(
    ...
    async (req, res) => {
        try {
            ...
            return apiSuccessRes(result.status, res, result.data, "Organizer stats fetched successfully");
        } catch (error) {
            return apiErrorRes(HTTP_STATUS.SERVER_ERROR, res, error.message);
        }
    }
...
router.get(
    ...
    async (req, res) => {
        try {
            ...
            return apiSuccessRes(result.status, res, result.data, "Customer stats fetched successfully");
        } catch (error) {
            return apiErrorRes(HTTP_STATUS.SERVER_ERROR, res, error.message);
        }
    }
...
router.get(
    ...
    async (req, res) => {
        try {
            ...
            return apiSuccessRes(result.status, res, result.data, "User specific stats fetched successfully");
        } catch (error) {
            return apiErrorRes(HTTP_STATUS.SERVER_ERROR, res, error.message);
        }
    }
